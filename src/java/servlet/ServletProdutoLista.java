 ...
 * @author ASUS
 */
@WebServlet(name = "ServletProdutoLista", urlPatterns = {"/ServletProdutoLista"})
public class ServletProdutoLista extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List listaProduto = query.getResultList();
        
        request.setAttribute("list", listaProduto);
