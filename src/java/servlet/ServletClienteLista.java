 ...
 * @author ASUS
 */
@WebServlet(name = "ServletClienteLista", urlPatterns = {"/ServletClienteLista"})
public class ServletClienteLista extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      EntityManagerFactory factory = Persistence.createEntityManagerFactory("StorePU");
        ...
        List listaCliente = query.getResultList();
        
        request.setAttribute("list", listaCliente);
