...
public class ServletProduto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Double preco =Double.parseDouble( request.getParameter("endereco"));
        ...
        em.getTransaction().begin();
         Categoria categoria = em.find(Categoria.class, idt);
        ...
        response.sendRedirect("/Store/produto/lista.jsp");
    }
